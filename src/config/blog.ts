...
export const BLOG_POSTS: BlogOutline[] = [
  ...
  },
  {
    ...
    estratto: "Tariffe, differenze tra i tipi di editing e come capire di quale hai davvero bisogno.",
    categoria: "Costi e budget",
    outline: [
  ...
  },
  {
    ...
    estratto: "Il percorso passo passo per pubblicare cartaceo ed ebook su Kindle Direct Publishing.",
  ...
  },
  {
    ...
    estratto: "Cos'è l'ISBN, a cosa serve e come richiederlo in Italia (o usare quello gratuito di KDP).",
    categoria: "Pubblicazione",
    outline: [
  ...
  },
  {
    ...
    estratto: "Fasce di prezzo del ghostwriting e cosa determina il costo di un libro scritto per te.",
    categoria: "Memoir e ghostwriting",
    outline: [
  ...
  },
  {
    ...
    estratto: "Due interventi diversi, con obiettivi e costi diversi. Come capire di cosa ha bisogno il tuo testo.",
    categoria: "Editing",
    outline: [
      "Cosa fa l'editing",
  ...
  },
  {
    ...
    estratto: "Principi di impaginazione professionale per interni leggibili e stampabili senza errori.",
  ...
  },
  {
    ...
    estratto: "Dalla stesura alla scheda Amazon: il percorso completo per pubblicare la propria storia.",
    categoria: "Memoir e ghostwriting",
    outline: [
  ...
  },
  {
    ...
    estratto: "Il libro come strumento di autorevolezza: come progettarlo, scriverlo e usarlo nel branding.",
